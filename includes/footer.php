        ...
        <div class="row align-items-center gy-3">
            <div class="col-md-6">
                <div class="d-flex align-items-center justify-content-center justify-content-md-start gap-2 mb-1">
                    ...
                    <span class="fw-bold text-white" style="color: #ffffff !important;">EventHub</span>
                </div>
                <p class="small text-white mb-0" style="color: #ffffff !important; opacity: 0.9;">
                    University Event Planning & Scheduling System &copy; <?php echo date('Y'); ?> NSBM Green University.
                </p>
            </div>
